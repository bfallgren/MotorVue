<template>
    <div>
        <b-row>
            ...
            <b-col lg="3" class="my-1">
                <b-button size="sm" pill variant="success" :to="{name: 'createVehicle'}">
                    Add Vehicle
                </b-button>
            </b-col>
            <b-col lg="3" class="my-1">
        ...
        >
            ...
            <template #cell(actions)="row">
                ...
                <b-button size="sm" pill variant="warning" :to="{name: 'editVehicle', params: { id: row.item.id }}">
                    Edit
                </b-button>
    ...
    export default {
        data() {
            return {
                ...
                sortDesc: false,
                fields: [
                { key: 'make', label: 'Make', sortable: false, headerTitle: "Vehicle Make" },
                { key: 'model', label: 'Model', sortable: false, headerTitle: "Vehicle Model" },
                { key: 'mfg_year', label: 'Year', sortable: true, headerTitle: "Vehicle build year" },
                { key: 'current_mileage', label: 'Miles', sortable: true, headerTitle: "Current vehicle miles" },
                { key: 'avatar', label: 'Avatar', sortable: false, headerTitle: "Vehicle photo" },
